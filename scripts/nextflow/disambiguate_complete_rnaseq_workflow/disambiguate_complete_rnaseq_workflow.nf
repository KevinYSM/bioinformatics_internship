...
process SAM_index{
        ...
        """
        SAM_sort_index.sh $SORTED_bam_file
        """
}
...
workflow{
        ...
        STAR_ch_human=STAR_align(read_pairs_ch)
        STAR_ch_mouse=STAR_align(read_pars_ch)

        DISAMBIGUATE_human=SAM_sort_name(STAR_ch_human)
        DISAMBIGUATE_mouse=SAM_sort_name(STAR_ch_mouse)

        DISAMBIGUATE_ch=DISAMBIGUATE_human.join(DISAMBIGUATE_mouse)

        
        
        SAM_index_ch=SAM_sort(DISAMBIGUATE_ch)
